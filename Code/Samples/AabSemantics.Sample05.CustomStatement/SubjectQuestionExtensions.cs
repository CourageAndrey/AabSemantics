...
namespace AabSemantics.Sample05.CustomStatement
{
	...
	{
		public static Task<IAnswer> WhoIsTallerThanAsync(this QuestionBuilder builder, IConcept person)
		{
		...
		public static Task<IAnswer> WhoIsShorterThanAsync(this QuestionBuilder builder, IConcept person)
		{
			var question = new GetShorterQuestion(person);
			return question.AskAsync(builder.SemanticNetwork.Context, null, builder.CancellationToken);
		}

		public static Task<IAnswer> IsTallerThanAsync(this QuestionBuilder builder, IConcept taller, IConcept shorter)
		{
