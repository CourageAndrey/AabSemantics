...
namespace AabSemantics.Sample07.CustomModule
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			AabSemantics.Serialization.Xml.SemanticNetworkXmlExtensions.SaveToXml(semanticNetwork, saveFile);
			AabSemantics.Serialization.Xml.SemanticNetworkXmlExtensions.LoadSemanticNetworkFromXml(saveFile, language);
