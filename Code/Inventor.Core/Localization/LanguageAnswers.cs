	...
	public class LanguageAnswers : ILanguageAnswers
	{
		...
		internal static LanguageAnswers CreateDefault()
		{
			return new LanguageAnswers
			{
				...
				HasSignTrue = $"Да, {Strings.ParamConcept} имеет признак {Strings.ParamSign} ",
				HasSignFalse = $"Нет, {Strings.ParamConcept} не имеет признак {Strings.ParamSign} ",
				HasSignsTrue = $"Да, {Strings.ParamConcept} имеет признаки ",
				HasSignsFalse = $"Нет, {Strings.ParamConcept} не имеет признаков ",
				Enumerate = $"{Strings.ParamParent} бывает следующим: ",
				SubjectArea = $"{Strings.ParamConcept} входит в предметные области: ",
				SubjectAreaConcepts = $"В предметную область {Strings.ParamConcept} входят следующие понятия: ",
				ConceptSigns = $"Понятие {Strings.ParamConcept} имеет следующие признаки",
