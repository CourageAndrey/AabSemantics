...
namespace Inventor.Core.Concepts
{
	public static class ComparisonSigns
	{
		...
		public static readonly IConcept IsEqualTo = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsEqualTo)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsEqualTo), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsEqualTo));

		public static readonly IConcept IsNotEqualTo = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsNotEqualTo)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsNotEqualTo), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsNotEqualTo));
		...
		public static readonly IConcept IsGreaterThanOrEqualTo = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsGreaterThanOrEqualTo)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsGreaterThanOrEqualTo), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsGreaterThanOrEqualTo));

		public static readonly IConcept IsGreaterThan = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsGreaterThan)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsGreaterThan), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsGreaterThan));

		public static readonly IConcept IsLessThanOrEqualTo = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsLessThanOrEqualTo)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsLessThanOrEqualTo), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsLessThanOrEqualTo));

		public static readonly IConcept IsLessThan = new SystemConcept($"{{{nameof(ComparisonSigns)}.{nameof(IsLessThan)}}}",
			new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptNames.IsLessThan), new LocalizedStringConstant(lang => lang.GetExtension<ILanguageMathematicsModule>().Concepts.SystemConceptHints.IsLessThan));
