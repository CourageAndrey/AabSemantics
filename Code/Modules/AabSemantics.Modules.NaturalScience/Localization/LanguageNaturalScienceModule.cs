...
{
	public interface ILanguageNaturalScienceModule
	{
	...
	[XmlType]
	public class LanguageNaturalScienceModule : LanguageExtension, ILanguageNaturalScienceModule
	{
		...
		public static LanguageNaturalScienceModule CreateDefault()
		{
			return new LanguageNaturalScienceModule()
			{
