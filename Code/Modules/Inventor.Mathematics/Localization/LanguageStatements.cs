...
namespace Inventor.Mathematics.Localization
{
	public interface ILanguageStatements
	{
		...
		Inventor.Mathematics.Localization.ILanguageConsistency Consistency
		{ get; }
	}

	[XmlType("MathematicsStatements")]
	public class LanguageStatements : ILanguageStatements
	{
		...
		public Inventor.Mathematics.Localization.LanguageConsistency ConsistencyXml
		{ get; set; }
		...
		[XmlIgnore]
		public Inventor.Mathematics.Localization.ILanguageConsistency Consistency
