...
{
	/// <summary>Statement wordings contributed by the mathematics module.</summary>
	...
	public class LanguageStatements : ILanguageStatements
	{
		...
		/// <summary>Wordings used when reporting consistency problems. In serializable form.</summary>
