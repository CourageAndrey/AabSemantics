...
{
	/// <summary>The processes module's string bundle: its attribute, concept, statement and question texts.</summary>
	...
	/// <summary>Serializable <see cref="ILanguageProcessesModule"/>, loaded from a language file.</summary>
	[XmlType]
